...
// filter [2,10];
// map [undefined,undefined,true,undefined,true ]
...
const map1 = array1.map(personObj => {
  ...
  let newPersonObj = {name: personObj.name, age: personObj.age};
  newPersonObj.age++
...
const filter3 = array1.filter(personObj => false);
// [];


const filter4 = array1.filter(personObj => true);
// [
//   { name: 'Farley', age: 6 },
//   { name: 'Asher', age: 5 },
//   { name: 'Sage', age: 3 },
