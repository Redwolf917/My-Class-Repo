...
function calculateMode(arr) {
  ...
  // Q: How are you going to do it?
  // A: Keyword `let` and assignment operator
...
const testCaseOne = [13, 18, 13, 14, 13, 16, 14, 21, 13]; //13

console.log(calculateMode(testCaseOne));

const testCaseTwo = [1, 3, 1, 1, 8]; //1
console.log(calculateMode(testCaseTwo));

const testCaseThree = [2, 14, 9, 10, 18, 14]; //14
console.log(calculateMode(testCaseThree));

const testCaseFour = [2, 3, 4, 5, 6]; //2
