...
function calculateMean(arr) {
  let solution = calculateSum(arr) / arr.length;
  return solution;
}
...
const arrOne = [12, 3, 5];
const arrTwo = [3, 13, 7, 5, 21, 23, 39, 23, 40, 23, 14, 12, 56, 23, 29];
const arrThree = [3, 5, 7, 12, 13, 14, 21, 23, 23, 23, 23, 29, 40, 56];
const arrFour = [11, 3, 9, 5, 8, 1];
