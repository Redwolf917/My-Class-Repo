...
const question01 = setInterval(function() {
  console.log("Question 01");
}, 1000 * 5);
...
const question02 = setInterval(function() {
  alert("Question 02");
}, 1000 * 10);
...
// every 2 seconds
const question03 = setInterval(function() {
...
const question04 = setInterval(function() {
  $("#question-03").empty();
}, 1000 * 6);
...
let counter = 0;
const question05 = setInterval(function() {
...
// every second
const question06 = setInterval(function() {
