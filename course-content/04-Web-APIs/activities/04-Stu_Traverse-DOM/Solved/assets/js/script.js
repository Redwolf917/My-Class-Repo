...
// const articlesDiv = document.body.children[1];

const headerDiv = document.getElementById("header");
// const headerDiv = document.body.children[0];
...
const articlesDivByAnyOtherName = articlesDiv;

articlesDivByAnyOtherName.style.fontSize  = "40px"
console.log("articlesDiv", articlesDiv);
